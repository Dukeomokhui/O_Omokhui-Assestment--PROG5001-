...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try (BufferedReader consoleReader = new BufferedReader(new InputStreamReader(System.in))) {
            ...
            // Read the file and process student records
            ...
            try (BufferedReader fileReader = new BufferedReader(new FileReader(filename))) {
                ...
                if ((line = fileReader.readLine()) != null) {
                    // Extract the unit name from the first line
            ...
            while (true){
                System.out.println("\nMENU:");
                System.out.println("1. Display students with total marks below a threshold");
                System.out.println("2. Display top 5 students with highest total marks");
                System.out.println("3. Display top 5 students with lowest total marks");
                ...
                switch (option) {
                    ...
                    case 4:
                        ...
                        break;
                    default:
                        // Invalid option input error validation
